...
<footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 mx-0 py-0 mt-5 mb-0 border-top bg-dark">
    ...
    <div class="col my-4 mx-1 text-center">
    ...
    <div class="col my-4 mx-2 pe-0 text-center col-md-auto">
      <h6 class="text-light fs-5 box-sizing-border-box">Contact</h6>
      <ul class="nav flex-column box-sizing-boder-box">
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-light text-muted-light fs-6">Email</a></li>
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-light text-muted-light fs-6">Follow Us: </a>
        <ul class="justify-content list-unstyled d-flex flex-nowrap ms-3">
        <li class="me-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"></path>
        </svg></li>
        <li class="me-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
