        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
            ...
            <div class="offcanvas-body">
                <!-- This is where the shopping cart loop goes !-->
                    ...
                    {?>
                        <div style="display: flex; justify-content: space-between; align-items: center; background-color:#F8F8F8">
                            <div>
                            <button type="button" class="btn btn-primary" style="padding: 5px 5px" id="addButton" onclick="addAmount(<?php echo $merged_products[$i]->getId()?>)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"></path>
                                </svg>
                            </button>
                            <h6 style="text-align: center"><?php echo $amounts[$i]?></h6>
