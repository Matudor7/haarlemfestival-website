    ...
    <div class="m-5" style="text-align: center;">
        ...
        <div style="background: #09B4BB; height: auto;">
            <div style="padding: 30px; font-size: 18px; text-align: left; padding-left: 30px; padding-right: 30px;" >
                <?=$html->getAboutUs()?>
                <p style="text-align: right"><strong> Type of food: <?=$restaurant->getRestaurantFoodType()?> </strong> </p>
            </div>
        </div><br><br>
    </div>
</div>
            ...
            <div style="background: #09B4BB; height: auto;">
                <div style="padding: 30px; font-size: 18px; text-align: left; padding-left: 30px; padding-right: 30px;" >
                    ...
                    <div class="container text-center">
                        <div class="row">
                            <div class="col">
                                <strong><?php echo $restaurant->getTimeSlots()[0]->format('H:i');?></strong>
                            </div>
                            <div class="col">
                                <strong><?php echo $restaurant->getTimeSlots()[1]->format('H:i');?></strong>
                            </div>
                            <div class="col">
                                <strong> <?php echo $restaurant->getTimeSlots()[2]->format('H:i');?></strong>
